...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    if (!formData.fullName.trim()) return toast.error("Nombre completo requerido");
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-2xl font-bold mt-2">Crear una Cuenta</h1>
      ...
      {/* right side */}
              ...
              subtitle="Conecta con tus amigos, comparte momentos y mantente en contacto con tus seres queridos."
              />
